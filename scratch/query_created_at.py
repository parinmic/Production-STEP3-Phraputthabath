...
assignments = fetch_data("production_assignments", "order=created_at.desc&limit=5")
for a in assignments:
    print(f"Created At: {a.get('created_at')} | Date: {a.get('production_date')} | SKU: {a.get('sku')} | Time: {a.get('deadline_time')} | Worker: {a.get('worker_name')}")
