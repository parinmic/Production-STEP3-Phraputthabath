  ...
  return (
    <div className="space-y-6 md:space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <WeeklyUploader type="sa-phok-special"  label="สะโพกพิเศษ"    theme={themes['sa-phok-special']} />
        <WeeklyUploader type="sam-chan-special"  label="สามชั้นพิเศษ"  theme={themes['sam-chan-special']} />
