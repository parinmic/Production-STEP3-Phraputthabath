  ...
  try {
    ...
    const records = rows
      .map((r: Record<string, unknown>) => ({
        ...
        yield_lt16:   Number(r['yield_lt16'])  || 0,
        yield_16_18:  Number(r['yield_16_18']) || 0,
        yield_gte18:  Number(r['yield_gte18']) || 0,
      }))
      .filter((r: { product_sap: string; raw_sap: string }) => r.product_sap && r.raw_sap)
